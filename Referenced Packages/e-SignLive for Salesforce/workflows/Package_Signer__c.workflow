...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>Package_Signer_Company</fullName>
...
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.CompanyName, Company__c)))</formula>
        <name>Package Signer Company</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_Email</fullName>
        <field>Email__c</field>
        <formula>IF(ISPICKVAL(Type__c, &apos;Contact&apos;), Contact__r.Email, 
IF(ISPICKVAL(Type__c, &apos;Lead&apos;), Lead__r.Email, 
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.Email, Email__c)))</formula>
        <name>Package Signer Email</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_First_Name</fullName>
        <field>First_Name__c</field>
        <formula>IF(ISPICKVAL(Type__c, &apos;Contact&apos;), Contact__r.FirstName, 
IF(ISPICKVAL(Type__c, &apos;Lead&apos;), Lead__r.FirstName, 
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.FirstName, First_Name__c)))</formula>
        <name>Package Signer First Name</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_Last_Name</fullName>
...
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.LastName, Last_Name__c)))</formula>
        <name>Package Signer Last Name</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_Name</fullName>
        <field>Name</field>
        <formula>First_Name__c &amp; &apos; &apos; &amp; Last_Name__c</formula>
        <name>Package Signer Name</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_Phone</fullName>
...
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.Phone, Phone__c)))</formula>
        <name>Package Signer Phone</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Package_Signer_Title</fullName>
...
IF(ISPICKVAL(Type__c, &apos;User&apos;), User__r.Title, Title__c)))</formula>
        <name>Package Signer Title</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Populate Package Signer Information</fullName>
        <actions>
            <name>Package_Signer_Company</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_Email</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_First_Name</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_Last_Name</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_Name</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_Phone</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Package_Signer_Title</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
